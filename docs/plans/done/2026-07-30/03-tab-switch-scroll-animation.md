...
## 상태
완료 (2026-07-30) — `#scroll-area`의 `scroll-behavior: smooth` 제거, `createTab()`에 스크롤 리셋 추가(7361df2). [`docs/self-check-request.md`](../2026-08-05/self-check-request.md) 3번 항목, 2026-07-22 요청.
