...
## 상태
완료 (2026-07-20, 커밋 `33debf8`) — 상세는 [`../plans/README.md`](./README.md#구현-요약-2026-07-20) 참고.
...
- 이 테스트 계층이 있었다면 잡혔을 실제 회귀 두 건(`docs/plans/done/2026-07-20/README.md` "2026-07-16 재검토 결과" #4 참고):
