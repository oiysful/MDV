(function (globalScope) {
  ...
  function createExplorerController({ getRefs, api, load, switchToExplorerTab, showAppContextMenu, clearExplorerRoot, syncExplorerHeader, getCurrentExplorerRoot, setCurrentExplorerRoot, setExplorerShowFullPath }) {
    ...
    async function openFolder() {
      ...
      setCurrentExplorerRoot(res.path)
    ...
    function renderTreeEntry(entry, container, depth) {
      ...
      if (entry.type === 'dir') {
        ...
        row.addEventListener('contextmenu', event => {
          if (!getCurrentExplorerRoot()) return
